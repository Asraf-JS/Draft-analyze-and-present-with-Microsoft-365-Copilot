...
1. Review the auto-generated summary, chapters, and key points that Teams has produced from the transcript.
...
1. Then ask:
    ...
    ```
    Who was assigned to update the guideline before the next review?
    ```

    > ***Note:** Copilot answers based strictly on the meeting transcript. If something was not said in the meeting, it will tell you so rather than guessing.*
...
1. Compare the Copilot-generated list against the **Action Items** tab that Teams generates automatically. Note any differences.
...
1. Draft a follow-up message to all participants covering the summary, decisions, action items, and next steps.
