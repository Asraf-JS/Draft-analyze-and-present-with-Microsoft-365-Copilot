...
- Use Copilot to summarise a long email thread.
- Draft a professional reply to a client complaint using Copilot.
- Use Coaching by Copilot to improve the tone and clarity of a draft.
- Draft a new email from scratch using a prompt.

**This lab should take approximately 30 minutes.**

---

## Task 1: Summarise an email thread
...
1. At the top of the email thread, select **Summary by Copilot**.

1. Read the summary. Note how Copilot condenses the back-and-forth into the key points.

    > ***Note:** The summary is generated from the email thread content only. Copilot does not have access to bank systems or account data.*

---

## Task 2: Draft a reply to a client complaint

1. Select **Reply** on Puan Roslinda's latest email.

1. In the reply compose window, select **Draft with Copilot** (the Copilot icon inside the compose area).
...
## Task 3: Improve the draft with Coaching
...
1. Review each suggestion and decide which ones to accept.

1. Once satisfied, finalise the email. You do not need to send it in this training environment.

---

## Task 4: Draft a new outreach email

1. Select **New Email** in Outlook.

1. In the compose window, select **Draft with Copilot**.
...
1. Review the draft and refine it with a follow-up prompt if needed:
    ...
    ```
    Make it sound less formal and more conversational, but still professional.
    ```
...
You have used Copilot in Outlook to summarise a complaint thread, draft a client-facing reply, improve it with coaching suggestions, and compose a new outreach email from scratch.
